---
layout: default
title: MacMTP Support
description: Support and troubleshooting information for MacMTP
permalink: /macmtp/support/
---

# MacMTP Support

MacMTP is a macOS utility for browsing an Android device over USB using the
...
- Select a destination folder in MacMTP when prompted.

## Connection troubleshooting

If the device does not appear or MacMTP cannot open it:
...
5. Quit and reopen MacMTP.

Only one application can normally own the Android device's MTP interface at a
time. Camera and photo-import services can sometimes claim it before MacMTP.
...
MacMTP does not send diagnostics automatically. You can copy or export a
...
- the MacMTP version and macOS version;
...
- [MacMTP privacy policy]({{ site.baseurl }}/macmtp/privacy/)
- [Delete MacMTP local data]({{ site.baseurl }}/macmtp/data-deletion/)
